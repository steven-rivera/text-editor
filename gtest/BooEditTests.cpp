...
TEST_F(BooEditTests, canMoveTextToNewLine)
{
    run({'s', 't', 'e', 'v', 'e', 'n', CTRL('U'), CTRL('U'), CTRL('M')});
    expectText({"stev", "en"});
    expectCursor(2, 1);
}

TEST_F(BooEditTests, canUndoNewLine)
{
    run({'s', 't', 'e', 'v', 'e', 'n', CTRL('U'), CTRL('U'), CTRL('M'), CTRL('Z')});
    expectText({"steven"});
    expectCursor(1, 5);
}

TEST_F(BooEditTests, backspaceShiftCharactersLeft)
{
    run({'s', 't', 'e', 'v', 'e', 'n', CTRL('U'), CTRL('U'), CTRL('H')});
    expectText({"steen"});
    expectCursor(1, 4);
}

TEST_F(BooEditTests, deleteLineWhenOnlyOneLine)
{
    run({'s', 't', 'e', 'v', 'e', 'n', CTRL('D')});
    expectText({""});
    expectCursor(1, 1);
}

TEST_F(BooEditTests, deleteLineTest1)
{
    run({'b', 'o', 'o', CTRL('M'), 'b', 'o', 'o', 'o', CTRL('D')});
    expectText({"boo"});
    expectCursor(1, 4);
}

TEST_F(BooEditTests, undoDeleteLineTest1)
{
    run({'b', 'o', 'o', CTRL('M'), 'b', 'o', 'o', 'o', CTRL('D'), CTRL('Z')});
    expectText({"boo", "booo"});
    expectCursor(2, 5);
}

TEST_F(BooEditTests, deleteLineTest2)
{
    run({'b', 'o', 'o', CTRL('M'), CTRL('M'), 't', 'e', 's', 't', CTRL('I'), CTRL('D')});
    expectText({"boo", "test"});
    expectCursor(2, 1);
}

TEST_F(BooEditTests, undoDeleteLineTest2)
{
    run({'b', 'o', 'o', CTRL('M'), CTRL('M'), 't', 'e', 's', 't', CTRL('I'), CTRL('D'), CTRL('Z')});
    expectText({"boo", "", "test"});
    expectCursor(2, 1);
}

TEST_F(BooEditTests, deleteLineTest3)
{
    run({'b', 'o', 'o', CTRL('M'), 'b', CTRL('D')});
    expectText({"boo"});
    expectCursor(1, 2);
}

TEST_F(BooEditTests, undoDeleteLineTest3)
{
    run({'b', 'o', 'o', CTRL('M'), 'b', CTRL('D'), CTRL('Z')});
    expectText({"boo", "b"});
    expectCursor(2, 2);
}

TEST_F(BooEditTests, backspaceTest)
{
    run({'b', 'o', 'o', CTRL('M'), 't', 'e', 's', 't', CTRL('U'), CTRL('U'), CTRL('U'), CTRL('H'), CTRL('H')});
    expectText({"booest"});
    expectCursor(1, 4);
}

TEST_F(BooEditTests, undoBackSpaceTest)
{
    run({'b', 'o', 'o', CTRL('M'), 't', 'e', 's', 't', CTRL('U'), CTRL('U'), CTRL('U'), CTRL('H'), CTRL('H'), CTRL('Z'), CTRL('Z')});
    expectText({"boo", "test"});
    expectCursor(2, 2);
}